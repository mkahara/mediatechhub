...
class EPKB_Upgrades {
	...
	public static function features_list( $features=array() ) {
		...
		$features['2020.09.01'] = array(
			'plugin'            => __( 'Import/Export KB', 'echo-knowledge-base'),
			...
			'image'             => 'https://www.echoknowledgebase.com/wp-content/uploads/2020/08/featured-screenshots-import.jpg',
		...
		$features['2020.08.09'] = array(
			...
			'description'       => '<p>' . __( 'Add Advanced Search box to any page like Contact Us form. Search across multiple KBs.', 'echo-knowledge-base') . '</p>',
